...
def load_data():
    gross=pd.read_csv("C:/Users/dell/Digipython/gross-enrollment-ratio-2013-2016.csv")
    return gross
...
choice=st.sidebar.radio("Select an analysis which you want:-",graphchoice)
...
def load_data1():
    dropout=pd.read_csv("C:/Users/dell/Digipython/dropout-ratio-2012-2015.csv")
    return dropout
...
def load_data2():
    computer=pd.read_csv("C:/Users/dell/Digipython/percentage-of-schools-with-comps-2013-2016.csv")
    return computer
...
def load_data3():
    water=pd.read_csv("C:/Users/dell/Digipython/percentage-of-schools-with-water-facility-2013-2016.csv")
